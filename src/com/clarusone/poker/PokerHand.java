...
public class PokerHand implements Comparable<PokerHand> {
    ...
    private boolean isEqualToOther(PokerHand that,int matches) {
    ...
    private void findCharsWhereDontMatch(PokerHand that) {
    	outerloop:
    	for(int i=0; i<arrayOfCards.length; i++) {
        	for(int j=0; j<arrayOfCards.length; j++) {
    ...
    private String getStringOf(PokerHand other,int index) {
